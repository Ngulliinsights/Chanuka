...
import { runAllIntegrationTests, formatIntegrationTestResults } from '../../shared/types/testing/integration/comprehensive-integration-test';
...
export class IntegrationTestRunner {
  ...
  async runTypeCompatibilityTests(): Promise<IntegrationTestRunnerResult> {
    ...
    try {
      const { runTypeCompatibilityTestSuite, TYPE_COMPATIBILITY_TEST_SUITE } = await import('../../shared/types/testing/integration/comprehensive-integration-test');
  ...
  async runMiddlewareTests(): Promise<IntegrationTestRunnerResult> {
    ...
    try {
      const { runValidationMiddlewareTestSuite, VALIDATION_MIDDLEWARE_TEST_SUITE } = await import('../../shared/types/testing/integration/comprehensive-integration-test');
  ...
  async runBackwardCompatibilityTests(): Promise<IntegrationTestRunnerResult> {
    ...
    try {
      const { BACKWARD_COMPATIBILITY_TESTS, runBackwardCompatibilityTest } = await import('../../shared/types/testing/integration/comprehensive-integration-test');
  ...
  async runDomainPatternValidation(): Promise<IntegrationTestRunnerResult> {
    ...
    try {
      const { DOMAIN_TYPES_FOR_PATTERN_VALIDATION, BUILTIN_DOMAIN_TYPE_PATTERN_RULES, validateDomainTypePatterns } = await import('../../shared/types/testing/integration/comprehensive-integration-test');
