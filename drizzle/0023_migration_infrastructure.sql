...
-- Creates tables for tracking migration state, validation checkpoints, and monitoring data
...
CREATE INDEX IF NOT EXISTS "idx_migration_metrics_component_id" ON "migration_metrics" ("component_id");
CREATE INDEX IF NOT EXISTS "idx_migration_metrics_timestamp" ON "migration_metrics" ("timestamp");
CREATE INDEX IF NOT EXISTS "idx_ab_testing_cohorts_user_id" ON "ab_testing_cohorts" ("user_id");
