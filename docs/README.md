...
- [Detailed Architecture](detailed-architecture.md) - High-level system architecture
- [Infrastructure Guide](infrastructure-guide.md) - Database schemas, infrastructure setup, and operational procedures
...
For database schemas, infrastructure setup, and operational procedures, see the [Infrastructure Guide](infrastructure-guide.md).
