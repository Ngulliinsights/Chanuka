...
### 8. `client/src/lib/types/` - Client Shared Types (Priority: MEDIUM - LEGACY STRUCTURE)
...
**Locations:**
```
client/src/lib/ui/types/index.ts             (UI component types)
client/src/lib/ui/dashboard/types/index.ts   (Dashboard UI types)
client/src/core/realtime/types/index.ts         (Real-time types)
client/src/lib/lib/query-client/types/       (React Query types)
client/src/lib/lib/form-builder/types/       (Form builder types)
client/src/lib/lib/validation/types/         (Validation types)
```
...
client/src/lib/lib/validation/types/validation.types.ts
...
client/src/lib/types/                  (Domain types)
...
client/src/lib/types/         ← CLIENT SHARED TYPES
