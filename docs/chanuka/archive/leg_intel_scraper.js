/**
 * ⚠️ ARCHIVED - REFERENCE ONLY ⚠️
 * 
 * LEGISLATIVE INTELLIGENCE SCRAPER ENGINE v2.0
 * --------------------------------------------
 * 
 * STATUS: ARCHIVED - This is an early prototype/reference implementation.
 * 
 * CURRENT IMPLEMENTATION:
 * Use server/features/government-data/services/parliament-scraper.service.ts
 * 
 * This file has been archived as part of the scraping consolidation effort.
 * The TypeScript implementation provides:
 * - Better type safety
 * - Three-layer architecture (Discovery → Extraction → Transformation)
 * - Comprehensive PDF parsing for voting records
