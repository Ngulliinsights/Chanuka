...
```
.
24_UNRESOLVED_IMPORTS_DETAILED_RATIONALE.md
ANALYSIS_INTEGRATION_STRATEGY.md
backup/
├── imports-20251211_011706/
│   ├── client/
│   │   ├── jest.a11y.config.js
│   │   ├── migration-helper.js
...
├── vite.production.config.ts
├── vite-plugin-suppress-warnings.js
CLIENT_BUG_FIX_REPORT.md
COMMUNITY_FIXES_SUMMARY.md
COMPLETE_ARCHITECTURE_INTEGRATION_SUMMARY.md
COMPLETION_REPORT.txt
COMPONENT_ARCHITECTURE_ANALYSIS.md
COMPONENT_REMEDIATION_PLAN.md
consolidate-directories.sh
CORE_INTEGRATION_AUDIT.md
...
├── pipeline-config.yml
├── README.md
DIRECTORY_ALIGNMENT_ANALYSIS.md
DIRECTORY_CONSOLIDATION_ANALYSIS.md
docker-compose.yml
Dockerfile
Dockerfile.client
docs/
...
FEATURES_FIXES_IMPLEMENTATION.md
FEATURES_INTEGRATION_AUDIT.md
FEATURES_INTEGRATION_STATUS.md
fix-imports.js
generate-structure-to-file.sh
IMPORT_INCONSISTENCIES_RESOLVED_SUMMARY.md
IMPORT_RESOLUTION_GUIDE.md
...
nginx.conf
nx.json
ORPHANED_COMPONENTS_ASSESSMENT.md
package.json
PAGES_ANALYSIS_VALIDATION.md
PAGES_CONSISTENCY_AUDIT.md
PAGES_FIXES_COMPLETE.md
PAGES_INTEGRATION_AUDIT_REPORT.md
PAGES_INTEGRATION_DETAILED.md
...
Generated on: 2025-12-11 02:24:28
