...
- **[Detailed Architecture](detailed-architecture.md)** - Comprehensive technical architecture
- **[Infrastructure Guide](infrastructure-guide.md)** - Database schemas, deployment, and operations
...
| [detailed-architecture.md](detailed-architecture.md) | High-level system architecture and domain designs | 3.0 | 2025-12-03 |
| [infrastructure-guide.md](infrastructure-guide.md) | Database schemas, infrastructure setup, and operations | 3.0 | 2025-12-03 |
| [documentation-standards.md](documentation-standards.md) | Standards for documentation creation and maintenance | 3.0 | 2025-12-03 |
...
| [project/brand-roadmap.md](project/brand-roadmap.md) | Brand development roadmap | Current |
| [project/manifesto.md](project/manifesto.md) | Project manifesto | Current |
| [project/problem-statement.md](project/problem-statement.md) | Problem statement | Current |
...
**Stakeholders:**
- [README.md](README.md)
- [sustainable_uprising.md](chanuka/sustainable_uprising.md)
- [global_implications.md](chanuka/global_implications.md)

### By Topic

**Architecture:** detailed-architecture.md, infrastructure-guide.md
...
1. Create the document following [documentation-standards.md](documentation-standards.md)
...
- Review [documentation-standards.md](documentation-standards.md) for contribution guidelines
- Check [CHANGELOG.md](../CHANGELOG.md) for recent updates
- Refer to individual document headers for authors and reviewers

---

*This index was last updated on December 3, 2025. For the most current information, check the repository directly.*