...
client/src/shared/types/                  ← CLIENT SHARED TYPES (UI/Component concerns)
│
├── index.ts
├── ui/
│   ├── components/
...
- `client/src/shared/lib/validation/types/validation.types.ts` → CONSOLIDATE
...
@types/shared/design-system.d.ts                       (move to client/src/shared/types/)
@types/shared/errors.d.ts                              (duplicates shared/types/core/errors)
@types/shared/ui.d.ts                                  (move to client/src/shared/types/ui/)
