...
import { CSPDirectives, SecurityEvent, CSPViolation } from './security-utils';
...
declare global {
  interface Window {
    ...
    __reportCSPViolation__?: (violation: CSPViolation) => void;
  }
}
...
export class CSPManager {
  ...
  private setupCSP(): void {
    ...
    logger.info('CSP Manager initialized with policy');
  }
  ...
  async shutdown(): Promise<void> {
    ...
    logger.info('CSP Manager shutdown complete');
  }
}
