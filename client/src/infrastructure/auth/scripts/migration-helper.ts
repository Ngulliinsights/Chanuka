...
export const IMPORT_MAPPINGS = {
  ...
  "import { authMiddleware } from '@client/store/middleware/authMiddleware'":
    "import { authMiddleware } from '@client/infrastructure/auth'",
  "from '@client/store/middleware/authMiddleware'": "from '@client/infrastructure/auth'",
  ...
  return [
    {
      ...
      items: [
        ...
        {
          task: 'All authService imports updated to @client/infrastructure/auth',
          completed: false,
          critical: true,
        },
        {
          task: 'All tokenManager imports updated to @client/infrastructure/auth',
          completed: false,
          critical: true,
        },
        {
          task: 'All sessionManager imports updated to @client/infrastructure/auth',
          completed: false,
          critical: true,
        },
      ],
