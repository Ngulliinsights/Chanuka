...
const CLEANUP_TASKS: CleanupTask[] = [
  ...
  },
  {
    ...
    filePath: 'client/src/infrastructure/api/auth.ts',
    action: 'remove',
    status: 'pending',
  },
  {
  ...
  },
  {
    ...
    filePath: 'client/src/infrastructure/api/client.ts',
    action: 'update',
    status: 'completed',
  },
  {
    ...
    filePath: 'client/src/infrastructure/api/index.ts',
    action: 'update',
    status: 'completed',
  },
];
...
export function generateCleanupReport(): {
  ...
  const nextSteps = [
    ...
    '2. Update any remaining components to use @client/infrastructure/auth imports',
