...
export async function createBackup(
  ...
  try {
    ...
    await fs.promises.writeFile(manifestPath, JSON.stringify(backup, null, 2), 'utf-8');
 ...
 */
export async function listBackups(config: RollbackConfig = DEFAULT_CONFIG): Promise<Backup[]> {
