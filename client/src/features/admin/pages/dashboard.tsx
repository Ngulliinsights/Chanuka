...
import type { PersonaType } from '@client/infrastructure/observability/personalization';
...
import { PersonalizedRecommendationsWidget, TrendingBillsWidget } from '@client/infrastructure/recommendation';
