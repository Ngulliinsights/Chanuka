        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-lg border border-gray-200 dark:border-gray-700">
            <div className="prose prose-lg dark:prose-invert max-w-none">
              ...
              <ul>
                <li>
                  <strong>Account Information:</strong> Email address, username, password
                </li>
                <li>
                  <strong>Profile Information:</strong> Name, bio, avatar (optional)
                </li>
                <li>
                  <strong>User Content:</strong> Comments, analysis, saved bills, preferences
                </li>
                <li>
                  <strong>Communications:</strong> Messages sent through our platform
                </li>
              </ul>
              ...
              <p>
                Third-party vendors who help us operate the platform (hosting, analytics, email
                delivery). These providers are contractually obligated to protect your data.
              </p>
              ...
              <p>
                You can update or delete your information through your account settings or by
                contacting us.
              </p>
              ...
              <p>
                ...
                legal compliance, fraud prevention, and legitimate business purposes.
              </p>
              ...
              <p>
                Under the Kenya Data Protection Act 2019, we process your personal data based on the
              ...
              <ul>
                ...
                <li>
                  <strong>Contract:</strong> Processing is necessary for the performance of our
                  service agreement with you
                </li>
                <li>
                  <strong>Legal Obligation:</strong> Processing is necessary to comply with Kenyan
                  law
                </li>
                <li>
                  <strong>Legitimate Interests:</strong> Processing is necessary for our legitimate
                  interests (e.g., fraud prevention, security)
                </li>
              </ul>
              ...
              <ul>
                ...
                <li>
                  <strong>Right to Lodge a Complaint:</strong> Lodge a complaint with the Office of
              ...
              <p className="mt-4">
                ...
                <a
                  href="mailto:privacy@chanuka.org"
              ...
              <p>
                Your information is primarily stored and processed in Kenya. If we transfer data
                outside Kenya, we ensure appropriate safeguards are in place as required by the
                Kenya Data Protection Act 2019, including data transfer agreements and ensuring
              ...
              <p>
                We have appointed a Data Protection Officer (DPO) as required by the Kenya Data
                Protection Act 2019. For data protection inquiries, contact our DPO at:{' '}
                <a
                  href="mailto:dpo@chanuka.org"
                  className="text-blue-600 dark:text-blue-400 hover:underline"
                >
                  dpo@chanuka.org
                </a>
