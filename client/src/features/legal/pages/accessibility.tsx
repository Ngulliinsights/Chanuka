import { Eye, Keyboard, MessageSquare, Smartphone, Mail } from 'lucide-react';
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl p-6 mb-8">
            ...
            <p className="text-gray-700 dark:text-gray-300">
              Chanuka is committed to ensuring digital accessibility for all Kenyans, including
              persons with disabilities. We continuously work to improve the accessibility and
              usability of our platform to ensure that everyone can participate in Kenya's
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-lg border border-gray-200 dark:border-gray-700">
            <div className="prose prose-lg dark:prose-invert max-w-none">
              ...
              <p>
                Chanuka strives to conform to the Web Content Accessibility Guidelines (WCAG) 2.1
                Level AA standards. These guidelines explain how to make web content more accessible
                for people with disabilities and improve usability for all users.
              </p>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 dark:text-gray-300 mt-3">
                        All images include descriptive alt text, and interactive elements have
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <ul className="space-y-2 text-gray-700 dark:text-gray-300">
                        <li>
                          <strong>Color Contrast:</strong> All text meets WCAG AA contrast ratios
                          (4.5:1 for normal text, 3:1 for large text)
                        </li>
                        <li>
                          <strong>Dark Mode:</strong> Full dark mode support for reduced eye strain
                        </li>
                        <li>
                        ...
                        <li>
                          <strong>Focus Indicators:</strong> Clear visual indicators for keyboard
                          focus
                        </li>
                        <li>
                          <strong>No Color-Only Information:</strong> Information is never conveyed
                          by color alone
                        </li>
                      </ul>
                    </div>
                ...
                <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-6">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <ul className="space-y-2 text-gray-700 dark:text-gray-300">
                        <li>
                          <strong>Touch Targets:</strong> All interactive elements are at least
                          44x44 pixels
                        </li>
                        <li>
                          <strong>Responsive Design:</strong> Fully functional on all screen sizes
                        </li>
                        <li>
                          <strong>Gesture Alternatives:</strong> All gestures have button
                          alternatives
                        </li>
                        <li>
                          <strong>Screen Reader Support:</strong> Compatible with mobile screen
                          readers
                        </li>
                      </ul>
                    </div>
              ...
              <p>
                Chanuka supports both English and Kiswahili to ensure accessibility for all Kenyans.
                You can switch languages at any time using the language selector in the navigation
                menu.
              </p>

              <h2>4. Document Accessibility</h2>
              <p>We strive to make all documents accessible:</p>
              <ul>
              ...
              <ul>
                ...
                <li>
                  Historical legislative documents may not meet current accessibility standards
                </li>
                <li>Complex data visualizations may require additional context</li>
              </ul>
              <p>
                We are actively working to address these limitations. If you encounter accessibility
                barriers, please let us know.
              </p>

              <h2>6. Assistive Technologies</h2>
              <p>Chanuka is designed to work with:</p>
              <ul>
              ...
              <p>
                We welcome your feedback on the accessibility of Chanuka. If you encounter
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-700 dark:text-gray-300">
                      ...
                      <br />
                      Address: Chanuka Platform, Westlands, Nairobi, Kenya
                      <br />
                      P.O. Box 12345-00100
                    </p>
                  </div>
              ...
              <p>
                ...
                with you to provide the information or service you need in an accessible format.
              </p>

              <h2>9. Legal Framework</h2>
              <p>Our accessibility commitment aligns with:</p>
              <ul>
              ...
              <p>
                Some content on Chanuka comes from third-party sources (e.g., government databases,
                embedded videos). While we cannot control the accessibility of third-party content,
                we:
              </p>
              <ul>
              ...
              <p>
                <strong>National Council for Persons with Disabilities</strong>
                <br />
                Website:{' '}
                <a
                  href="https://www.ncpwd.go.ke"
                  className="text-blue-600 dark:text-blue-400 hover:underline"
                  target="_blank"
