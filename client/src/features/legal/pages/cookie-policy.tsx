        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl p-6 mb-8">
            ...
            <p className="text-gray-700 dark:text-gray-300">
              ...
              understanding how you use our platform. This policy explains how Chanuka uses cookies
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-lg border border-gray-200 dark:border-gray-700">
            <div className="prose prose-lg dark:prose-invert max-w-none">
                  ...
                  <div className="flex items-start space-x-3 mb-3">
                    ...
                    <div>
                      ...
                      <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                        <li>
                          <strong>session_id:</strong> Maintains your login session (expires after
                          24 hours)
                        </li>
                        <li>
                  ...
                  <div className="flex items-start space-x-3 mb-3">
                    ...
                    <div>
                      ...
                      <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                        ...
                        <li>
                          <strong>dashboard_layout:</strong> Saves your dashboard customization
                        </li>
                        <li>
                ...
                <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-6">
                  <div className="flex items-start space-x-3 mb-3">
                    ...
                    <div>
                      ...
                      <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                        <li>
                          <strong>_ga:</strong> Google Analytics - tracks user sessions (expires
                          after 2 years)
                        </li>
                        <li>
                          <strong>_gid:</strong> Google Analytics - distinguishes users (expires
                          after 24 hours)
                        </li>
                        <li>
                          <strong>analytics_session:</strong> Our internal analytics (expires after
                          30 minutes)
                        </li>
                      </ul>
                    </div>
                ...
                <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-6">
                  <div className="flex items-start space-x-3 mb-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 dark:text-gray-300">
                        We do not use marketing or advertising cookies. Chanuka is a civic platform
                        focused on transparency and does not engage in targeted advertising.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <p>
                ...
                Navigate to Settings → Privacy → Cookie Preferences to enable or disable optional
                cookies.
              </p>
              ...
              <p>Learn more about cookie management:</p>
              <ul>
                <li>
                  <a
              ...
              <p>We use limited third-party services that may set cookies:</p>
              <ul>
                <li>
                  <strong>Google Analytics:</strong> For usage analytics (only if you consent)
                </li>
                <li>
              ...
              <p>
                You can see the expiry date of each cookie in your browser's cookie management
                tools.
              </p>

              <h2>6. Data Protection Compliance</h2>
              <p>Our use of cookies complies with the Kenya Data Protection Act 2019. We:</p>
              <ul>
              ...
              <p>
                ...
                legal requirements. We will notify you of material changes through our platform or
                via email.
              </p>
