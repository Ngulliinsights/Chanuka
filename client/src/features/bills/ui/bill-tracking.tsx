...
const BillTracking = ({
  ...
  const handlePreferenceChange = useCallback(
    (key: keyof TrackingPreferences, value: boolean) => {
  ...
  const isUpdating = useMemo(
    () =>
      trackBillMutation.isPending ||
      untrackBillMutation.isPending ||
          ...
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="text-center">
                ...
                <p className="text-2xl font-bold">{formatNumber(stats.comments)}</p>
              </div>
              <div className="text-center">
                <div className="flex items-center justify-center space-x-1 text-muted-foreground mb-1">
                ...
                <p className="text-2xl font-bold">{formatNumber(stats.shares)}</p>
              </div>
              <div className="text-center">
                <div className="flex items-center justify-center space-x-1 text-muted-foreground mb-1">
