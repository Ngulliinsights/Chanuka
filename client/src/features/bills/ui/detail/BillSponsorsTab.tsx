    ...
    <div className="space-y-6">
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="grid w-full grid-cols-3 mb-6">
          ...
          <TabsTrigger value="network">Financial Network</TabsTrigger>
          <TabsTrigger value="cosponsors">Co-Sponsors ({coSponsors.length})</TabsTrigger>
        </TabsList>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                      <div className="space-y-2">
                        ...
                        <div className="flex items-center gap-2 text-sm">
                          ...
                          <span>
                            {primarySponsor.state} - Constituency {primarySponsor.district}
                          </span>
                        </div>
                        <div className="flex items-center gap-2 text-sm">
              ...
              <div className="space-y-4">
                {coSponsors.length > 0 ? (
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-sm text-muted-foreground">
                            ...
                            {sponsor.district && ` - Constituency ${sponsor.district}`}
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="text-center py-8 text-muted-foreground">
                    No co-sponsors found for this bill.
                  </div>
                )}
              </div>
            </CardContent>
