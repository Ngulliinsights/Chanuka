    ...
    <div className="container mx-auto px-4 py-6 max-w-7xl">
      ...
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">
          Comprehensive analysis framework and data verification process
        </p>
      </div>
      ...
      <Card className="mb-6">
        <CardHeader>
          ...
          <p className="text-muted-foreground">
            Chanuka employs a systematic, multi-layered approach to analyze potential conflicts of
            interest and external influences on legislation
          </p>
        </CardHeader>
        <CardContent>
                    ...
                    {[
                      {
                        ...
                        description:
                          'Systematic compilation of verifiable government data including financial disclosures, committee assignments, and voting histories.',
                      ...
                      },
                      {
                        ...
                        description:
                          'Advanced tracking of campaign contributions and financial relationships across multiple election cycles.',
                      ...
                      },
                      {
                        ...
                        description:
                          'Natural language processing comparison of bill text with industry publications and lobbying materials.',
                      ...
                      },
                      {
                        ...
                        description:
                          'Incorporation of verified open source intelligence from credible media, academic research, and civil society investigations.',
                      ...
                      },
                      {
                        ...
                        description:
                          'Proprietary algorithm combines all data points to generate nuanced conflict risk scores.',
                ...
                <CardContent>
                  <div className="space-y-4">
                    <Card>
                      <CardHeader>
                        <CardTitle className="text-base">
                          Automated Public Records Scraper
                        </CardTitle>
                      </CardHeader>
                      <CardContent>
                    ...
                    <Card>
                      <CardHeader>
                        <CardTitle className="text-base">
                          Corporate Relationship Graph Engine
                        </CardTitle>
                      </CardHeader>
                      <CardContent>
                        <p className="text-sm text-muted-foreground mb-2">
                          Maps complex corporate ownership structures, subsidiary relationships, and
                          business partnerships to identify indirect financial connections.
                        </p>
                        <div className="text-xs text-blue-600">
                          Entities tracked: 1.2M+ companies | Relationship depth: 5 degrees |
                          Jurisdictions: 34
                        </div>
                      </CardContent>
                    </Card>
                    ...
                    <Card>
                      ...
                      <CardContent>
                        <p className="text-sm text-muted-foreground mb-2">
                          Natural language processing analysis of 300+ news outlets, trade
                          publications, and investigative reports to identify emerging conflicts.
                        </p>
                        <div className="text-xs text-blue-600">
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      {[
                        {
                          source: 'Documentary Evidence Support',
                          weight: 95,
                          color: 'bg-green-500',
                        },
                        {
                          source: 'Independent Verification Status',
                          weight: 85,
                          color: 'bg-blue-500',
                        },
                    ...
                    {[
                      {
                        ...
                        color: 'bg-red-500',
                        description:
                          'Measures scope and significance of direct or indirect financial benefits',
                      },
                      {
                        ...
                        color: 'bg-yellow-500',
                        description:
                          'Evaluates closeness and nature of relationships between sponsors and benefiting entities',
                      },
                      {
                      ...
                      },
                      {
                        ...
                        color: 'bg-green-500',
                        description:
                          "Measures the sponsor's ability to shape specific clauses and amendments",
                      },
                    ].map(dimension => (
                  ...
                  <Card className="bg-blue-50 border-blue-200">
                    <CardContent className="p-4">
                      ...
                      <p className="text-sm text-blue-800">
                        Every public submission receives response within 72 hours. Verified
                        information is credited to contributors in our public database. Our expert
                        verification network ensures accuracy while protecting legitimate
                        whistleblowers and concerned citizens.
                      </p>
                    </CardContent>
                  </Card>
                </CardContent>
                ...
                <CardContent>
                  <div className="space-y-4">
                    <Card className="border-blue-200">
                      ...
                      <CardContent>
                        <p className="text-sm text-muted-foreground mb-2">
                          Healthcare Reform Bill Section 12 demonstrates{' '}
                          <strong>72% textual similarity</strong> with pharmaceutical industry white
                          paper published in 2023.
                        </p>
                        <div className="text-xs text-blue-600">
                          Key Evidence: 247 matching phrases, 89 identical technical terms, 12
                          sequential paragraphs with {'>'}90% similarity
                        </div>
                      </CardContent>
                    </Card>
                    ...
                    <Card className="border-green-200">
                      ...
                      <CardContent>
                        <p className="text-sm text-muted-foreground mb-2">
                          Digital learning provisions show <strong>68% precision alignment</strong>{' '}
                          with vendor specifications. Concurrent analysis reveals timing correlation
                          with campaign contributions.
                        </p>
                        <div className="text-xs text-green-600">
                          Financial Trail: 7 related entities, $45,000 total contributions, 60-day
                          correlation window
                        </div>
                      </CardContent>
                    </Card>
                    ...
                    <Card className="border-red-200">
                      ...
                      <CardContent>
                        <p className="text-sm text-muted-foreground mb-2">
                          Donation volumes increased by <strong>340%</strong> in 30-day period
                          preceding policy position reversal. Pattern repeats across three separate
                          legislative initiatives.
                        </p>
                        <div className="text-xs text-red-600">
                          Pattern Details: 3 legislative initiatives, 340% contribution spike, 97%
                          probability of non-random occurrence
                        </div>
                      </CardContent>
                    </Card>
                  </div>
      ...
      <Card className="mb-6">
        ...
        <CardContent>
          <div className="space-y-3 text-sm text-muted-foreground">
            <p>
              <strong>Data Completeness:</strong> Our analysis is based on publicly available
              information. Some financial relationships or conflicts may not be captured if not
              publicly disclosed.
            </p>
            <p>
              <strong>Temporal Accuracy:</strong> Financial interests and affiliations change over
              time. We strive to maintain current data but there may be delays in updates.
            </p>
            <p>
              <strong>Interpretation:</strong> Conflict scores represent potential risks based on
              available data. They do not constitute accusations of wrongdoing or improper behavior.
            </p>
            <p>
      ...
      <div className="flex justify-between items-center">
        ...
        <Link to={`/bills/${bill_id}/sponsorship-analysis`}>
          <Button>Return to Navigation</Button>
        </Link>
      </div>
    </div>
  );
