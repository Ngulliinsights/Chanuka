...
export function useCampaign(campaignId: string | undefined) {
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const response = await globalApiClient.get(`/api/advocacy/campaigns/${campaignId}`);
...
export function useJoinCampaign() {
  ...
  return useMutation({
    mutationFn: async (campaignId: string) => {
      const response = await globalApiClient.post(`/api/advocacy/campaigns/${campaignId}/join`);
...
export function useLeaveCampaign() {
  ...
  return useMutation({
    mutationFn: async (campaignId: string) => {
      const response = await globalApiClient.post(`/api/advocacy/campaigns/${campaignId}/leave`);
      return response.data;
    },
    onSuccess: (_, campaignId) => {
      queryClient.invalidateQueries({ queryKey: ['campaign', campaignId] });
...
export function useUserActions(userId: string | undefined, filters?: { status?: string }) {
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const response = await globalApiClient.get(`/api/advocacy/users/${userId}/actions?${params.toString()}`);
...
export function useCampaignActions(campaignId: string | undefined) {
  return useQuery({
    ...
    queryFn: async () => {
      if (!campaignId) throw new Error('Campaign ID is required');
      const response = await globalApiClient.get(`/api/advocacy/campaigns/${campaignId}/actions`);
      return response.data.actions as ActionItem[];
    },
    enabled: !!campaignId,
  });
...
export function useStartAction() {
  ...
  return useMutation({
    mutationFn: async (actionId: string) => {
      const response = await globalApiClient.post(`/api/advocacy/actions/${actionId}/start`);
...
export function useCompleteAction() {
  ...
  return useMutation({
    mutationFn: async ({
      ...
      const response = await globalApiClient.post(`/api/advocacy/actions/${actionId}/complete`, {
        outcome,
        actualTimeMinutes,
      });
      return response.data.action as ActionItem;
...
export function useCampaignMetrics(campaignId: string | undefined) {
  return useQuery({
    ...
    queryFn: async () => {
      if (!campaignId) throw new Error('Campaign ID is required');
      const response = await globalApiClient.get(`/api/advocacy/campaigns/${campaignId}/metrics`);
...
export function useCampaignImpact(campaignId: string | undefined) {
  return useQuery({
    ...
    queryFn: async () => {
      if (!campaignId) throw new Error('Campaign ID is required');
      const response = await globalApiClient.get(`/api/advocacy/campaigns/${campaignId}/impact`);
...
export function useRecordImpact() {
  ...
  return useMutation({
    mutationFn: async ({
      ...
      const response = await globalApiClient.post(`/api/advocacy/campaigns/${campaignId}/impact`, {
        impactType,
        value,
        description,
        evidenceLinks,
...
export function useUserDashboard(userId: string | undefined) {
  return useQuery({
    ...
    queryFn: async () => {
      if (!userId) throw new Error('User ID is required');
      const response = await globalApiClient.get(`/api/advocacy/users/${userId}/dashboard`);
...
export function useTrendingCampaigns(limit: number = 10) {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await globalApiClient.get(`/api/advocacy/campaigns/trending?limit=${limit}`);
      return response.data.campaigns as Campaign[];
    },
