...
import { ResponsiveContainer, ResponsiveGrid } from '../shared/design-system/components';

export default function HomePage() {
  return (
    <ResponsiveContainer maxWidth="laptop-lg" padding="md">
        ...
        <ResponsiveGrid columns={{ mobile: 1, tablet: 2, desktop: 3 }} gap="md" className="mb-12">
          <Card>
            <CardHeader>
