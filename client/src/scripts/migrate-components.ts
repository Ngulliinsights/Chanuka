...
const COMPONENT_MIGRATIONS: MigrationRule[] = [
  // Import migrations
  {
    ...
    replacement: "import { UnifiedButton } from '@client/shared/design-system';",
  ...
  },
  {
    ...
    replacement: "import { UnifiedCard, UnifiedCardContent, UnifiedCardDescription, UnifiedCardHeader, UnifiedCardTitle } from '@client/shared/design-system';",
    description: 'Migrate Card imports to Unified components'
  },
  {
    pattern: /import\s*{\s*Badge\s*}\s*from\s*['"]\.\.\/components\/ui\/badge['"];?/g,
    replacement: "import { UnifiedBadge } from '@client/shared/design-system';",
