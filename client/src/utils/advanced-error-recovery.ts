...
import { AppError, ErrorDomain, ErrorSeverity, ErrorRecoveryStrategy } from './unified-error-handler';
...
export class SmartRecoveryEngine {
  ...
  private shouldUseStrategy(strategy: SmartRecoveryStrategy, error: AppError, context?: RecoveryContext): boolean {
