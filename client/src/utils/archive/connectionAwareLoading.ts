...
type NetworkInfoShape = Partial<ConnectionInfo> & {
...
class ConnectionAwareLoader {
  ...
  public getConnectionInfo(): ConnectionInfo {
    if ('connection' in navigator) {
      const connection = (navigator as unknown as { connection?: NetworkInfoShape }).connection;
      return {
...
// React hook is imported at the top of the file
