...
export const DEMO_BILLS: DemoBill[] = [
  {
    ...
    summary: 'Comprehensive legislation establishing individual data ownership rights, regulating tech company data collection, and creating enforcement mechanisms for privacy violations. Includes provisions for data portability, consent management, and algorithmic transparency.',
    status: 'committee',
    urgencyLevel: 'high',
    ...
    sponsors: [
      { id: 1, name: 'Hon. Sarah Johnson', party: 'Democratic', district: 'District 12', isPrimary: true },
      { id: 2, name: 'Hon. Michael Chen', party: 'Republican', district: 'District 8', isPrimary: false }
    ]
  },
  {
    id: 2,
    ...
    summary: 'Establishes national framework for 50% emissions reduction by 2030 through renewable energy incentives, carbon pricing mechanisms, and just transition support for fossil fuel communities. Creates green jobs program and climate resilience infrastructure fund.',
    status: 'passed',
    ...
    sponsors: [
      { id: 3, name: 'Hon. Maria Rodriguez', party: 'Democratic', district: 'District 5', isPrimary: true },
      { id: 4, name: 'Hon. James Wilson', party: 'Independent', district: 'District 15', isPrimary: false }
    ]
  },
  {
    id: 3,
    ...
    summary: 'Expands healthcare coverage through public option, enables Medicare prescription drug negotiation, and strengthens community health centers. Includes telehealth expansion and mental health parity enforcement provisions.',
    status: 'introduced',
    urgencyLevel: 'high',
    ...
    controversyLevel: 'medium',
    sponsors: [
      { id: 5, name: 'Hon. David Kim', party: 'Democratic', district: 'District 3', isPrimary: true }
    ]
  },
  {
    id: 4,
    ...
    summary: 'Provides funding for school technology infrastructure, digital literacy programs, and broadband access in underserved communities. Establishes privacy protections for student data and educational technology standards.',
    status: 'committee',
    urgencyLevel: 'medium',
    ...
    sponsors: [
      { id: 6, name: 'Hon. Lisa Thompson', party: 'Republican', district: 'District 7', isPrimary: true },
      { id: 7, name: 'Hon. Robert Garcia', party: 'Democratic', district: 'District 11', isPrimary: false }
    ]
  }
];
  ...
  const comments = [
    {
      ...
      content: 'This bill addresses critical privacy concerns while maintaining innovation incentives. The enforcement mechanisms are well-structured.',
    ...
    },
    {
      ...
      role: 'Citizen',
      content: 'Finally, legislation that puts individual privacy rights first. The data portability provisions are especially important.',
    ...
    },
    {
      ...
      content: 'While we support privacy protection, some provisions may hinder innovation. Suggest amendments to Section 4.2.',
