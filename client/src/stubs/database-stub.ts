...
export const database = {
  query: () => {
    throw new Error('Database operations are not available in the client. Use API endpoints instead.');
  },
  transaction: () => {
    throw new Error('Database transactions are not available in the client. Use API endpoints instead.');
  }
};
