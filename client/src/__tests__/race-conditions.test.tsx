...
} from '../infrastructure/store/slices/loadingSlice';
...
describe('Race Condition Fixes', () => {
  ...
  describe('Loading Slice Race Conditions', () => {
    it('should handle concurrent statistics updates safely', async () => {
      ...
      const promises = Array(100)
        ...
        .map(() =>
          store.dispatch(
            loadingSlice.actions.updateStatsAtomic({
    ...
    it('should handle batch statistics updates atomically', async () => {
      ...
      const promises = Array(50)
        .fill(null)
        .map(() => store.dispatch(loadingSlice.actions.batchStatsUpdate(batchUpdates)));
  ...
  describe('Request Deduplication', () => {
    ...
    it('should deduplicate concurrent identical requests', async () => {
      ...
      const promises = Array(10)
        .fill(null)
        .map(() => deduplicator.deduplicate('test-key', mockRequest));
