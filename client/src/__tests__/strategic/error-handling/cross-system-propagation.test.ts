...
import { SecurityErrorHandler } from '@client/core/error/security/SecurityErrorHandler';
import { HookErrorHandler } from '@client/core/error/hooks/HookErrorHandler';
import { ServiceErrorHandler } from '@client/core/error/services/ServiceErrorHandler';
import { LibraryErrorHandler } from '@client/core/error/library/LibraryErrorHandler';
import { ErrorPropagationService } from '@client/core/error/ErrorPropagationService';
import { ErrorContext } from '@client/core/error/types/ErrorContext';
import { ErrorSeverity } from '@client/core/error/types/ErrorSeverity';
import { ErrorType } from '@client/core/error/types/ErrorType';

// Mock external dependencies
vi.mock('@client/core/error/security/SecurityErrorHandler');
vi.mock('@client/core/error/hooks/HookErrorHandler');
vi.mock('@client/core/error/services/ServiceErrorHandler');
vi.mock('@client/core/error/library/LibraryErrorHandler');
vi.mock('@client/core/error/ErrorPropagationService');
