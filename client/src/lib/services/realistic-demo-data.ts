...
export const demoBills: DemoBill[] = [
  {
    ...
    summary:
      'A Bill to amend the Public Finance Management Act to enhance transparency in government spending, strengthen oversight mechanisms for public resources, and establish mandatory quarterly budget execution reports accessible to the public.',
    ...
    potentialImpact: {
      economic:
        'Could reduce government waste by an estimated 15-20% through improved oversight and transparency mechanisms.',
      social:
        'Increases public trust in government institutions and empowers citizens to participate in budget oversight.',
      legal:
        'Strengthens legal framework for prosecuting corruption and financial misconduct in public sector.',
    },
    timeline: [
      {
        date: '2024-10-15',
...

  {
    ...
    summary:
      "A Bill to strengthen Kenya's climate change response by establishing mandatory carbon emission targets for industries, creating a National Climate Adaptation Fund, and enhancing penalties for environmental violations.",
    ...
    potentialImpact: {
      economic:
        'Estimated to create 200,000 green jobs while imposing compliance costs of KSh 80 billion on industries over 5 years.',
      social:
        'Improves air quality in urban areas and builds climate resilience for vulnerable communities, particularly in arid regions.',
      legal:
        "Aligns Kenya's legal framework with Paris Agreement commitments and establishes clear enforcement mechanisms.",
    },
    timeline: [
      {
        date: '2024-09-08',
      ...
      },
      {
        ...
        description:
          'Meetings with industry associations, environmental groups, and county governments',
      },
      {
        date: '2024-11-20',
...

  {
    ...
    summary:
      "A comprehensive bill to regulate Kenya's digital economy, establish data protection standards for tech companies, create a framework for digital taxation, and protect citizens' privacy rights in the digital age.",
    ...
    potentialImpact: {
      economic:
        'Expected to generate KSh 15 billion annually in digital taxes while potentially increasing compliance costs for tech companies.',
      social:
        'Strengthens privacy protection for 25 million internet users and promotes local digital innovation.',
      legal:
        'Creates comprehensive legal framework for digital economy regulation and aligns with global data protection standards.',
    },
    timeline: [
      {
        date: '2024-11-10',
...
export const demoComments: DemoComment[] = [
  {
    ...
    userId: 'user_002',
    content:
      "This bill addresses a critical gap in our public finance oversight. The quarterly reporting requirement will significantly improve transparency. However, I'm concerned about the implementation timeline - 30 days might be too ambitious for counties with limited technical capacity.",
    ...
    replies: [
      {
        ...
        userId: 'user_001',
        content:
          'Good point about the timeline. Maybe a phased implementation starting with national level, then counties with higher capacity, followed by support for smaller counties?',
...

  {
    ...
    userId: 'user_003',
    content:
      'As a young Kenyan, I strongly support this climate bill. The green jobs program could be transformative for youth unemployment. But we need to ensure the training programs are accessible in rural areas, not just urban centers.',
...
export class RealisticDemoDataService {
  ...
  async getBills(filters?: {
    ...
    if (filters?.policyArea) {
      filteredBills = filteredBills.filter(bill => bill.policyAreas.includes(filters.policyArea!));
    }
  ...
  async getEngagementStats(): Promise<{
    ...
    const totalVotes = demoBills.reduce(
      (sum, bill) =>
        sum +
        bill.engagement.votes.support +
        bill.engagement.votes.oppose +
        bill.engagement.votes.neutral,
      0
    );
