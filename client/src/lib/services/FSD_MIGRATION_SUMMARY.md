...
- **To:** `client/src/lib/infrastructure/navigation/navigation-service.ts`
- **Reason:** Browser API abstraction for testing (infrastructure concern)
- **Export:** Available via `@client/lib/infrastructure/navigation/navigation-service`
...
import { navigationService } from '@client/lib/infrastructure/navigation/navigation-service';
