/**
 * Select Component - UNIFIED & TOKEN-BASED
 *
 * ✅ Uses design tokens
 * ✅ Accessible select with Radix UI
    ...
    <SelectPrimitive.Content
      ...
      className={cn(
        [
          ...
          'text-[hsl(var(--color-popover-foreground))]',
          'shadow-md',
  ...
  <SelectPrimitive.Item
    ...
    className={cn(
      [
        ...
        'focus:bg-[hsl(var(--color-accent))]',
        'focus:text-[hsl(var(--color-accent-foreground))]',
