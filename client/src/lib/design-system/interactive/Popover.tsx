...
const EnhancedPopover: React.FC<
  EnhancedPopoverProps & React.ComponentPropsWithoutRef<typeof PopoverPrimitive.Root>
> = ({ children, onError, fallbackContent, open, onOpenChange, ...props }) => {
...
export { Popover, PopoverTrigger, PopoverContent, EnhancedPopover, EnhancedPopoverContent };
