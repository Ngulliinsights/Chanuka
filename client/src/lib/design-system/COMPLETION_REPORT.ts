...
export const MIGRATION_DETAILS = {
  interactive: {
    originalLocation: 'client/src/lib/design-system/components/',
    newLocation: 'client/src/lib/design-system/interactive/',
    componentCount: 8,
    migratedComponents: [
  ...
  feedback: {
    originalLocation: 'client/src/lib/design-system/components/',
    newLocation: 'client/src/lib/design-system/feedback/',
    componentCount: 3,
    migratedComponents: [
  ...
  typography: {
    originalLocation: 'client/src/lib/design-system/components/',
    newLocation: 'client/src/lib/design-system/typography/',
    componentCount: 1,
    migratedComponents: [
  ...
  media: {
    originalLocation: 'client/src/lib/design-system/components/',
    newLocation: 'client/src/lib/design-system/media/',
    componentCount: 1,
    migratedComponents: [
...
export const STRUCTURAL_CHANGES = {
  deletedDirectories: [
    'client/src/lib/design-system/components/ [REDUNDANT - ALL CONTENT MIGRATED]',
  ],
