...
export const Header = React.memo<HeaderProps>(
  ({
    ...
    const iconButtonClasses =
      !transparentOnTop || isScrolled ? 'hover:bg-gray-100' : 'hover:bg-white/20';
          ...
          <div className="flex items-center gap-2 sm:gap-4 min-w-0">
            ...
            {onMenuToggle && (
              <Button
                ...
                className={cn('md:hidden flex-shrink-0', textColor, iconButtonClasses)}
          ...
          <div className="flex items-center gap-1 sm:gap-2 flex-shrink-0">
            ...
            {showSearch && (
              <Button
                ...
                className={cn('md:hidden', textColor, iconButtonClasses)}
            ...
            {showNotifications && (
              <Button
                ...
                className={cn('relative transition-colors', textColor, iconButtonClasses)}
            ...
            {showUserMenu && (
              <Button
                ...
                className={cn('transition-colors', textColor, iconButtonClasses)}
