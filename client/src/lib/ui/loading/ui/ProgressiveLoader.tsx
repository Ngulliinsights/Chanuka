  ...
  ({
    ...
    return (
      ...
      >
        ...
        <LoadingIndicator message={currentStageData.message} showMessage={true} size="md" />
        ...
        <div className="w-full max-w-md space-y-2">
          {stages.map((stage: any, index: number) => {
            ...
            return (
              <div
                key={stage.id}
                className={cn('flex items-center space-x-3 p-2 rounded-md transition-colors', {
              ...
              >
                ...
                <span className="flex-1 text-sm font-medium">{stage.message}</span>
                {stage.duration && (
