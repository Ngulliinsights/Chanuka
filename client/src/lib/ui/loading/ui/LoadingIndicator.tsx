...
export const LoadingIndicator = React.memo<LoadingIndicatorProps>(
  ({
    ...
    const sizeClass =
      LOADING_SIZES[size as keyof typeof LOADING_SIZES] || LOADING_SIZES[DEFAULT_LOADING_SIZE];
    ...
    const renderPulse = () => (
      <div
        className={cn(sizeClass, 'rounded-full animate-pulse', colorClasses[color])}
