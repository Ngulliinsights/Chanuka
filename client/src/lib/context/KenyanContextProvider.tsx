...
export const KenyanContextProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
    ...
    () => ({
      levels: {
        ...
        ward: {
          ...
          institutions: ['Ward Representative', 'Ward Development Committee', 'Village Councils'],
        },
      },
      legislature: {
        nationalAssembly: {
    ...
    () => ({
      billTypes: {
        ...
        constitutional: {
          ...
          description:
            language === 'sw' ? 'Miswada ya kubadilisha katiba' : 'Bills to amend the constitution',
          process: [
        ...
        county: {
          ...
          description:
            language === 'sw' ? 'Miswada ya sheria za kaunti' : 'County-level legislation',
          process: [
      ...
      stages: {
        ...
        secondReading: {
          ...
          description:
            language === 'sw' ? 'Mjadala wa jumla wa mswada' : 'General debate on the bill',
        },
        committeeStage: {
        ...
        thirdReading: {
          ...
          description:
            language === 'sw' ? 'Mjadala wa mwisho na kupiga kura' : 'Final debate and voting',
        },
        assent: {
  ...
  return <KenyanContext.Provider value={contextValue}>{children}</KenyanContext.Provider>;
};
