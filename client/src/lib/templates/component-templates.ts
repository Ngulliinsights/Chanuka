...
export class ComponentTemplateGenerator {
  ...
  private generateIndexFile(): TemplateFile {
    ...
    if (this.config.hasErrorHandling) {
      exports.push(
        `export * from '@client/lib/design-system/interactive/errors.ts';`,
...
import { ${pascalName}ValidationError } from '@client/lib/design-system/interactive/errors.ts';
...
`;
  ...
  private generateRecoveryFile(): TemplateFile {
    ...
    const content = `import { ${pascalName}Error, ${pascalName}ErrorType } from '@client/lib/design-system/interactive/errors.ts';
...
import { ${pascalName}Data, ${pascalName}Error, Use${pascalName}Options, Use${pascalName}Result } from '@client/lib/types';
${this.config.hasValidation ? `import { validate${pascalName}Data } from '@workspace/validation';` : ''}
${this.config.hasErrorHandling ? `import { ${camelName}RecoveryManager } from '@lib/recovery';` : ''}
...
`;
  ...
  private generateMainUtilFile(): TemplateFile {
    ...
    const content = `import { ${pascalName}Data, ${pascalName}Config } from '@client/lib/types';
...
import { ${pascalName}Props } from '@client/lib/types';
${this.config.hasHooks ? `import { use${pascalName} } from '@client/lib/hooks';` : ''}
...
`;
  ...
  private generateCoreFile(): TemplateFile {
    ...
    const content = `import { ${pascalName}Data, ${pascalName}Config, ${pascalName}Error } from '@client/lib/types';
${this.config.hasValidation ? `import { validate${pascalName}Data, validate${pascalName}Config } from '@workspace/validation';` : ''}
...
import { ${pascalName}UI } from '@lib/ui/${pascalName}UI';
...
import { use${pascalName} } from '@client/lib/hooks/use${pascalName}';
...
} from '@lib/utils/${this.toCamelCase(componentName)}-utils';
import { ${pascalName}Data, ${pascalName}Config } from '@client/lib/types';
