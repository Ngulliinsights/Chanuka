 ...
 * @example
 * // Import base types
 * import type { DashboardConfig, WidgetConfig } from '@client/lib/types/dashboard';
 *
 * // Import metrics
 * import type { AnalyticsMetrics, TimeSeries } from '@client/lib/types/dashboard';
 *
 * // Import component props
 * import type { DashboardProps, WidgetProps } from '@client/lib/types/dashboard';
 *
 * // Import events
 * import type { DashboardEvent, WidgetUpdatedEvent } from '@client/lib/types/dashboard';
 */
 ...
 *
 * @example
 * import { DEFAULT_BREAKPOINTS } from '@client/lib/types/dashboard';
 ...
 *
 * @example
 * import { DEFAULT_RESPONSIVE_LAYOUTS } from '@client/lib/types/dashboard';
 */
 ...
 *
 * @example
 * import { DEFAULT_PREFERENCES } from '@client/lib/types/dashboard';
 */
 ...
 *
 * @example
 * import { createDashboardConfig } from '@client/lib/types/dashboard';
 ...
 *
 * @example
 * import { createWidgetConfig } from '@client/lib/types/dashboard';
