...
export const MIGRATION_SUMMARY = {
  ...
  sourceDirectory: 'client/src/shared/design-system/components/',
  targetDirectories: [
...
export const EXPORT_VERIFICATION = {
  ...
  afterMigration: {
    ...
    example1: 'import { Button } from "@client/shared/design-system/interactive"',
    example2: 'import { Alert } from "@client/shared/design-system/feedback"',
    example3: 'import { Button, Alert } from "@client/shared/design-system" (barrel)',
...
export const SAFE_DELETION_CHECKLIST = {
  ...
  deleteCommand: 'rm -rf client/src/shared/design-system/components/',
