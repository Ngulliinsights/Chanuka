...
const cardVariants = cva(
  ['rounded-[0.5rem]', 'transition-all duration-150 ease-out', 'overflow-hidden'].join(' '),
  {
    variants: {
      variant: {
        default: [
        ...
        elevated: ['bg-[hsl(var(--color-card))]', 'shadow-lg', 'hover:shadow-xl'].join(' '),
        ...
        ghost: ['bg-transparent', 'border-none', 'shadow-none'].join(' '),
      },
