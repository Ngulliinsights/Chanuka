...
export const Logo = React.memo<LogoProps>(
  ({ className = '', size = 'md', showText = true, textClassName = '', variant = 'default' }) => {
    ...
    return (
      <div className="flex items-center space-x-2">
        <img src="/Chanuka_logo.svg" alt="Chanuka Logo" className={logoClasses} />
        {showText && <span className={textClasses}>Chanuka</span>}
      </div>
    );
  }
);
