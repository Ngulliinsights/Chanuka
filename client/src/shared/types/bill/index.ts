 ...
 * import type { Bill, BillStatus, BillAnalysis } from '@client/shared/types/bill';
 *
 * // Import analytics types
 * import type { BillAnalytics, EngagementAnalytics } from '@client/shared/types/bill';
 *
 * // Import service types
 * import type { PaginatedBillsResponse, BillEngagementMetrics } from '@client/shared/types/bill';
 *
 * // Import auth types
 * import type { User, UserRole, ExtendedUser } from '@client/shared/types/bill';
 */
