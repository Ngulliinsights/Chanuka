...
import { GlobalLoadingProvider, GlobalLoadingIndicator } from '@client/shared/ui/loading';
import { store } from '@client/shared/infrastructure/store';
...
```tsx
import { useGlobalLoadingIndicator } from '@client/shared/ui/loading';
...
```tsx
import { useLoadingState, useGlobalLoadingIndicator } from '@client/shared/ui/loading';
