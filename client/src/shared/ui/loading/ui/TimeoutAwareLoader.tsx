    ...
    return (
      ...
      >
        ...
        {timeout > 0 && (
          <div className="relative">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <span className="text-xs font-medium text-gray-600">{formatTime(remainingTime)}</span>
            </div>
          </div>
        )}
        ...
        <div className="text-center space-y-1">
          <div className="text-sm text-gray-600">Elapsed: {formatTime(elapsedTime)}</div>
          {timeout > 0 && (
            <div className="text-xs text-gray-500">Timeout in: {formatTime(remainingTime)}</div>
          )}
        </div>
        ...
        {showWarning && showTimeoutWarning && (
          <div className="text-center p-3 bg-orange-50 border border-orange-200 rounded-md">
            <div className="flex items-center justify-center space-x-2">
              ...
              <span className="text-sm font-medium text-orange-700">Taking longer than usual</span>
            </div>
