...
import { EducationalFramework } from '../EducationalFramework';
...
describe('EducationalFramework', () => {
  ...
  it('renders the educational framework header', () => {
    render(<EducationalFramework bill={mockBill} />);
  ...
  it('applies custom className when provided', () => {
    ...
    const { container } = render(
      <EducationalFramework bill={mockBill} className={customClass} />
    );
