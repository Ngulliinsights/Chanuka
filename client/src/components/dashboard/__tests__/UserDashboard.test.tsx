...
import { UserDashboard } from '../../shared/dashboard';
...
vi.mock('../sections/EngagementHistorySection', () => ({
  EngagementHistorySection: () => (
    <div data-testid="engagement-history-section">Engagement History</div>
  ),
}));
...
// Modal components removed as part of consolidation
...
vi.mock('../modals/DashboardPreferencesModal', () => ({
  DashboardPreferencesModal: () => (
    <div data-testid="dashboard-preferences-modal">Dashboard Preferences</div>
  ),
}));
...
describe('UserDashboard', () => {
  ...
  it('shows sign in message when user is not authenticated', () => {
    ...
    renderWithRouter(<UserDashboard variant="full-page" />);

    expect(screen.getByText('Please sign in')).toBeInTheDocument();
    expect(
      screen.getByText('You need to be signed in to view your personalized dashboard.')
    ).toBeInTheDocument();
  });
  ...
  it('shows dashboard content when user is authenticated', () => {
    ...
    expect(
      screen.getByText('Track legislation, measure your impact, and stay engaged')
    ).toBeInTheDocument();
  });
