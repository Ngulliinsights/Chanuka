...
export function OAuthLogin({ onSuccess, onError, className = '', redirectTo }: OAuthLoginProps) {
  ...
  useEffect(() => {
    ...
    const handleOAuthCallback = async () => {
      ...
      if (code && provider && providers.some(p => p.id === provider)) {
        setLoading(provider);
        ...
        try {
          ...
          logger.error('OAuth callback handling failed:', { component: 'OAuthLogin' }, error);
  ...
  }, [providers, onSuccess, onError, redirectTo, updateUser]);
