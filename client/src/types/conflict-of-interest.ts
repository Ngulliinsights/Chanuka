/**
 * Conflict of Interest Data Types
 * 
 * Types for representing financial interests, organizational connections,
 * and transparency data for conflict of interest analysis.
 */
...
export interface VotingPattern {
  ...
  financialCorrelation: number; // -1 to 1 scale
}
