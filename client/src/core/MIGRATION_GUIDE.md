...
This guide helps you migrate from scattered WebSocket and real-time implementations to the consolidated `client/src/core/realtime` module.

## Overview

All WebSocket and real-time functionality has been consolidated into a single module at `client/src/core/realtime/`. This provides a unified, type-safe interface for all real-time features.
...
1. **Import Path Errors**
   - Ensure `@client/core/realtime` is correctly configured in your module resolution
