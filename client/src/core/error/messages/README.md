...
```
client/src/core/error/messages/
...
```typescript
import { errorMessageService } from '@client/core/error/messages';
...
```typescript
import { useErrorMessages } from '@client/core/error/messages';
...
```typescript
import { ErrorMessageProvider, useErrorMessageContext } from '@client/core/error/messages';
...
```typescript
import { createEnhancedErrorMessage } from '@client/core/error/messages';
...
Run tests with:
```bash
npm test -- client/src/core/error/messages/__tests__
```
