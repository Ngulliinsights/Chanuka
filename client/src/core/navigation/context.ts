...
import { NavigationState, NavigationAction, NavigationContextValue, UserRole, BreadcrumbItem, RelatedPage } from './types';
import { navigationReducer } from './reducer';
import { generateBreadcrumbs, calculateRelatedPages, determineNavigationSection, isNavigationPathActive } from './utils';
import { isNavigationPathActive as coreIsNavigationPathActive } from '@shared/core/src/utils/navigation-utils';
