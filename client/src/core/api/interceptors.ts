/**
 * Request/Response interceptor types and implementation.
 * Consolidated from services/apiInterceptors.ts for unified API client architecture.
 */
 ...
 * Functions that can modify outgoing requests.
 */
 ...
 * Functions that can modify incoming responses.
 */
 ...
 * Add more here to modify all incoming responses.
 */
