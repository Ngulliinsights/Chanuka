...
router.get('/me', authenticateToken, async (req: AuthenticatedRequest, res) => {
  ...
  try {
    ...
    logger.error('Error fetching profile:', { component: 'SimpleTool' }, error as Record<string, any> | undefined);
...
router.patch('/me', authenticateToken, async (req: AuthenticatedRequest, res) => {
  ...
  try {
    ...
    logger.error('Error updating profile:', { component: 'SimpleTool' }, error as Record<string, any> | undefined);
...
router.patch('/me/basic', authenticateToken, async (req: AuthenticatedRequest, res) => {
  ...
  try {
    ...
    logger.error('Error updating basic info:', { component: 'SimpleTool' }, error as Record<string, any> | undefined);
...
router.patch('/me/interests', authenticateToken, async (req: AuthenticatedRequest, res) => {
  ...
  try {
    ...
    logger.error('Error updating interests:', { component: 'SimpleTool' }, error as Record<string, any> | undefined);
...
router.get('/:userId', async (req, res) => {
  ...
  try {
    ...
    logger.error('Error fetching public profile:', { component: 'SimpleTool' }, error as Record<string, any> | undefined);
    return ApiError(res, 'Failed to fetch profile', 500, ApiResponseWrapper.createMetadata(startTime));
  }
});
...
router.get('/me/preferences', authenticateToken, async (req: AuthenticatedRequest, res) => {
  ...
  try {
    ...
    logger.error('Error fetching preferences:', { component: 'SimpleTool' }, error as Record<string, any> | undefined);
...
router.patch('/me/preferences', authenticateToken, async (req: AuthenticatedRequest, res) => {
  ...
  try {
    ...
    logger.error('Error updating preferences:', { component: 'SimpleTool' }, error as Record<string, any> | undefined);
...
router.get('/me/verification', authenticateToken, async (req: AuthenticatedRequest, res) => {
  ...
  try {
    ...
    logger.error('Error fetching verification status:', { component: 'SimpleTool' }, error as Record<string, any> | undefined);
...
router.patch('/me/verification', authenticateToken, async (req: AuthenticatedRequest, res) => {
  ...
  try {
    ...
    logger.error('Error updating verification status:', { component: 'SimpleTool' }, error as Record<string, any> | undefined);
...
router.get('/me/engagement', authenticateToken, async (req: AuthenticatedRequest, res) => {
  ...
  try {
    ...
    logger.error('Error fetching engagement history:', { component: 'SimpleTool' }, error as Record<string, any> | undefined);
...
router.get('/me/complete', authenticateToken, async (req: AuthenticatedRequest, res) => {
  ...
  try {
    ...
    logger.error('Error fetching complete profile:', { component: 'SimpleTool' }, error as Record<string, any> | undefined);
...
router.post('/me/engagement/:billId', authenticateToken, async (req: AuthenticatedRequest, res) => {
  ...
  try {
    ...
    logger.error('Error updating engagement:', { component: 'SimpleTool' }, error as Record<string, any> | undefined);
...
router.get('/search/:query', async (req, res) => {
  ...
  try {
    ...
    logger.error('Error searching users:', { component: 'SimpleTool' }, error as Record<string, any> | undefined);
