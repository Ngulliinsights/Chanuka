...
import { analysisRouter } from '@server/features/analysis/presentation/http/routes';
import analyticsRouter from '@server/features/analytics/presentation/http/routes/analytics.routes';
import { argumentIntelligenceRouter } from '@server/features/argument-intelligence/presentation/http/routes';
...
import { constitutionalAnalysisRouter } from '@server/features/constitutional-analysis/presentation/http/routes';
import coverageRouter from '@server/features/bills/presentation/http/coverage-routes';
import { default as pretextDetectionRouter } from '@server/features/pretext-detection/presentation/http/routes';
...
import featureFlagRouter from '@server/features/feature-flags/presentation/http/routes';
...
import { router as electoralAccountabilityRoutes } from '@server/features/electoral-accountability/presentation/http/routes';
import governmentDataRoutes from '@server/features/government-data/presentation/http/government-data.routes';
