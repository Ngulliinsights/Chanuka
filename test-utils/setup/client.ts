/**
 * UNIFIED CLIENT TEST SETUP
 * 
 * This is the single source of truth for all client unit test configuration.
 * Replaces:
 * - client/src/test-utils/setup.ts
 * - client/src/setupTests.ts
 * 
 * Used by: client-unit test project in vitest.workspace.unified.ts
 */
...
// =============================================================================
// JSDOM POLYFILLS & GLOBAL MOCKS
// =============================================================================

// ResizeObserver polyfill (used by UI libraries)
...
/**
 * Global test utilities available in all client test files
 * Use these for consistent mock data and common test operations
 */
global.testUtils = {
