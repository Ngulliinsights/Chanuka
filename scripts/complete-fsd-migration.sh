...
mkdir -p client/src/shared/infrastructure/{system,compatibility,asset-loading}
...
if [ -d "client/src/components/system" ]; then
    ...
    cp -r client/src/components/system/* client/src/shared/infrastructure/system/ 2>/dev/null || true
...
if [ -d "client/src/components/compatibility" ]; then
    ...
    cp -r client/src/components/compatibility/* client/src/shared/infrastructure/compatibility/ 2>/dev/null || true
...
if [ -d "client/src/components/asset-loading" ]; then
    ...
    cp -r client/src/components/asset-loading/* client/src/shared/infrastructure/asset-loading/ 2>/dev/null || true
...
mkdir -p client/src/shared/ui/{loading,notifications,offline,accessibility}
mkdir -p client/src/shared/design-system/primitives
...
if [ -d "client/src/components/loading" ]; then
    ...
    cp -r client/src/components/loading/* client/src/shared/ui/loading/ 2>/dev/null || true
...
if [ -d "client/src/components/notifications" ]; then
    ...
    cp -r client/src/components/notifications/* client/src/shared/ui/notifications/ 2>/dev/null || true
...
if [ -d "client/src/components/offline" ]; then
    ...
    cp -r client/src/components/offline/* client/src/shared/ui/offline/ 2>/dev/null || true
...
if [ -d "client/src/components/accessibility" ]; then
    ...
    cp -r client/src/components/accessibility/* client/src/shared/ui/accessibility/ 2>/dev/null || true
...
if [ -d "client/src/components/ui" ]; then
    ...
    cp -r client/src/components/ui/* client/src/shared/design-system/primitives/ 2>/dev/null || true
...
if [ -d "client/src/components/integration" ]; then
    ...
    mkdir -p client/src/shared/ui/integration
    cp -r client/src/components/integration/* client/src/shared/ui/integration/ 2>/dev/null || true
...
if [ -d "client/src/components/examples" ]; then
    ...
    mkdir -p client/src/shared/ui/examples
    cp -r client/src/components/examples/* client/src/shared/ui/examples/ 2>/dev/null || true
...
if [ -d "client/src/components/shared" ]; then
    ...
    cp -r client/src/components/shared/* client/src/shared/ui/ 2>/dev/null || true
    print_success "Shared components moved"
fi

# Move any remaining loose files
if [ -f "client/src/components/connection-status.tsx" ]; then
    cp client/src/components/connection-status.tsx client/src/shared/ui/
fi

if [ -f "client/src/components/database-status.tsx" ]; then
    cp client/src/components/database-status.tsx client/src/shared/ui/
fi

if [ -f "client/src/components/OfflineIndicator.tsx" ]; then
    cp client/src/components/OfflineIndicator.tsx client/src/shared/ui/offline/
fi

if [ -f "client/src/components/OfflineModal.tsx" ]; then
    cp client/src/components/OfflineModal.tsx client/src/shared/ui/offline/
fi
...
cat > client/src/shared/infrastructure/index.ts << 'EOF'
...
find client/src -name "*.tsx" -o -name "*.ts" | xargs sed -i 's|@client/components/system/|@client/shared/infrastructure/system/|g' 2>/dev/null || true
find client/src -name "*.tsx" -o -name "*.ts" | xargs sed -i 's|@client/components/compatibility/|@client/shared/infrastructure/compatibility/|g' 2>/dev/null || true
find client/src -name "*.tsx" -o -name "*.ts" | xargs sed -i 's|@client/components/asset-loading/|@client/shared/infrastructure/asset-loading/|g' 2>/dev/null || true
...
find client/src -name "*.tsx" -o -name "*.ts" | xargs sed -i 's|@client/components/loading/|@client/shared/ui/loading/|g' 2>/dev/null || true
find client/src -name "*.tsx" -o -name "*.ts" | xargs sed -i 's|@client/components/notifications/|@client/shared/ui/notifications/|g' 2>/dev/null || true
find client/src -name "*.tsx" -o -name "*.ts" | xargs sed -i 's|@client/components/offline/|@client/shared/ui/offline/|g' 2>/dev/null || true
find client/src -name "*.tsx" -o -name "*.ts" | xargs sed -i 's|@client/components/accessibility/|@client/shared/ui/accessibility/|g' 2>/dev/null || true

# Update design system imports
find client/src -name "*.tsx" -o -name "*.ts" | xargs sed -i 's|@client/components/ui/|@client/shared/design-system/primitives/|g' 2>/dev/null || true
...
find client/src -name "*.tsx" -o -name "*.ts" | xargs sed -i 's|@/components/|@client/shared/ui/|g' 2>/dev/null || true
