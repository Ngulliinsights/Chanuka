...
export const billDbToDomain: Transformer<BillTable, Bill> = {
  transform(dbBill: BillTable): Bill {
    return {
      ...
      createdBy: dbBill.created_by ?? undefined,
      updatedBy: dbBill.updated_by ?? undefined,
    };
  },
  ...
  reverse(bill: Bill): BillTable {
    return {
      ...
      introduction_date: bill.introductionDate,
      congress: bill.congress,
      session: bill.session,
      sponsor_id: bill.sponsorId as unknown as SponsorId,
      ...
      created_by: (bill.createdBy ?? null) as UserId | null,
      updated_by: (bill.updatedBy ?? null) as UserId | null,
...
export const billEngagementMetricsDbToDomain: Transformer<BillEngagementMetricsTable, BillEngagementMetrics> = {
  ...
  reverse(metrics: BillEngagementMetrics): BillEngagementMetricsTable {
    return {
      bill_id: metrics.billId,
      views: metrics.views,
      comments: metrics.comments,
      shares: metrics.shares,
      endorsements: metrics.endorsements,
      oppositions: metrics.oppositions,
...
export const sponsorDbToDomain: Transformer<SponsorTable, Sponsor> = {
  ...
  reverse(sponsor: Sponsor): SponsorTable {
    return {
      id: sponsor.id,
      bill_id: sponsor.billId,
      legislator_id: sponsor.legislatorId as unknown as LegislatorId,
      legislator_name: sponsor.legislatorName,
      party: sponsor.party,
      state: sponsor.state,
      district: sponsor.district ?? null,
      sponsor_type: sponsor.sponsorType,
      sponsorship_date: sponsor.sponsorshipDate,
...
export const billDomainToApi: Transformer<Bill, ApiBill> = {
  transform(bill: Bill): ApiBill {
    return {
      ...
      priority: bill.priority,
      introductionDate: dateToStringTransformer.transform(bill.introductionDate),
      congress: bill.congress,
      session: bill.session,
      ...
      timeline: bill.timeline.map(e => billTimelineEventDomainToApi.transform(e)),
      subjects: bill.subjects,
      policyAreas: bill.policyAreas,
      relatedBills: bill.relatedBills,
      engagement: billEngagementMetricsDomainToApi.transform(bill.engagement),
  ...
  reverse(apiBill: ApiBill): Bill {
    return {
      ...
      engagement: billEngagementMetricsDomainToApi.reverse(apiBill.engagement),
      ...
      createdBy: apiBill.createdBy as UserId | undefined,
      updatedBy: apiBill.updatedBy as UserId | undefined,
    };
  },
};
...
export const sponsorDomainToApi: Transformer<Sponsor, ApiSponsor> = {
  transform(sponsor: Sponsor): ApiSponsor {
    return {
      ...
      legislatorName: sponsor.legislatorName,
      party: sponsor.party,
      state: sponsor.state,
      district: sponsor.district,
      sponsorType: sponsor.sponsorType,
      sponsorshipDate: dateToStringTransformer.transform(sponsor.sponsorshipDate),
