...
│  └─ YES → client/src/core/api/types/ or client/src/shared/types/
│  └─ NO  → Is it a component/hook/context type?
│           ├─ YES → client/src/shared/types/{components,hooks,context}/
...
4. **Where am I putting this?**
   ...
   - [ ] `client/src/shared/types/` → Client shared UI types
